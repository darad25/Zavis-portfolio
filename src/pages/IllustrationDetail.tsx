...
import { NextPrevIllustrationNav } from '../components/case-study/NextPrevIllustrationNav';

export const IllustrationDetail = () => {
    const { slug } = useParams();
    const illustration = ILLUSTRATIONS.find(p => p.slug === slug);

    if (!illustration || !slug) {
        ...
        >
            <div className="container" style={{ paddingTop: 'var(--spacing-3xl)' }}>
                ...
                {illustration.process && illustration.process.length > 0 && (
                    <section style={{ maxWidth: '900px', margin: '0 auto', paddingBottom: 'var(--spacing-4xl)' }}>
                        <h2 style={{
            ...
            {/* Footer Navigation */}
            <NextPrevIllustrationNav currentSlug={slug} />
        </motion.main>
    );
};
